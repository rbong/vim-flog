...
nnoremap <buffer> <silent> <Plug>(FlogVSplitCommitPathsRight) :<C-U>call flog#run_tmp_command('vertical belowright Git show --format=medium %h -- %p')<CR>
...
if !hasmapto('<Plug>(FlogToggleSort)')
  nmap <buffer> gs <Plug>(FlogToggleSort)
endif
